...
extern const u8 gNameChoice_Adrian[];
extern const u8 gNameChoice_Dorian[];
extern const u8 gNameChoice_Rowan[];
extern const u8 gNameChoice_Blaire[];
extern const u8 gNameChoice_Cedric[];
extern const u8 gNameChoice_Lucian[];
extern const u8 gNameChoice_Orion[];
extern const u8 gNameChoice_Silas[];
...
extern const u8 gOakSpeech_Text_AdventureSetupPreface[];
extern const u8 gOakSpeech_Text_LevelCapQuestion[];
extern const u8 gOakSpeech_Text_BattleStyleQuestion[];
extern const u8 gOakSpeech_Text_AdventureSetupCanChangeLater[];
...
extern const u8 gOakSpeech_Text_YourSecondRivalsNameWhatWasIt[];
extern const u8 gOakSpeech_Text_ConfirmRivalName[];
extern const u8 gOakSpeech_Text_ConfirmRival2Name[];
extern const u8 gOakSpeech_Text_RememberRivalsName[];
extern const u8 gOakSpeech_Text_RememberRival2Name[];
